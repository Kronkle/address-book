...
templates['profile'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<form class=\"addContactForm\">\r\n"
    + ((stack1 = helpers["if"].call(depth0,(depth0 != null ? depth0.isContact : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.program(4, data, 0),"data":data})) != null ? stack1 : "");
  ...
  return "<div class=\"app-person-profile docs-highlight docs-blue\" data-intro=\"Person Profile\" data-position=\"bottom\">\r\n	<div class=\"app-person-profile-header\">\r\n		<div class=\"app-person-profile-photo\" style=\"background-image: url("
    ...
    + "</h2>\r\n		"
    + ((stack1 = helpers["if"].call(depth0,(depth0 != null ? depth0.loggedIn : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
